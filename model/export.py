#python export.py --input_type image_tensor --pipeline_config_path ssd/pipeline.config --trained_checkpoint_prefix PATH/model.ckpt-largestnumber --output_directory inference_graph
